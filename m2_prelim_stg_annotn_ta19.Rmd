...
```{r}
# bsub < /lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/mali22_code_lnk/3_prelim_stage_annotation/submsn_seu_norm_CbEdCr_singleR.sh
...
```{r, eval=FALSE}
# ## !!! NOTE - scmap in farm
# ## Alternative to run scmap in farm since it take long here
# # bsub < /lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Mali2/mali22_code_lnk/3_prelim_stage_annotation/submsn_scmap_multi_ref_bsub.sh
# # --input_seu "/lustre/scratch126/tol/teams/lawniczak/users/jr35/phd/Talleh/data/processed/Pf/MSC*/seu_obj/dense_CbendrCr.RDS" \
# 
# bpc_seu_prelim_anotd <- list.files("data/processed/Pf", pattern = "dense.*_(CbendrCr)_prelim_anotd.RDS$", full.names = T, recursive = T, include.dirs = T) %>%
# set_names(nm = (str_remove_all(.,'data/processed/Pf/|/seu_obj/|bpc_seu|bp|dense.*|_prelim_anotd|.RDS'))) %>% 
#   .[sample_name] %>%
#   .[!is.na(.)] %>%
#   map(readRDS)
```
